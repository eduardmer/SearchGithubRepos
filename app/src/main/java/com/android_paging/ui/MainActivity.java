...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReposAdapter adapter=new ReposAdapter(new ReposComparator());
        binding.recyclerView.setAdapter(adapter.withLoadStateFooter(new LoadingStateAdapter(adapter::retry)));
    ...
    static class ReposComparator extends DiffUtil.ItemCallback<RepositoryItems> {
        @Override
